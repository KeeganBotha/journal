...
-- CreateIndex
CREATE UNIQUE INDEX "journal_entry_ownerId_date_key" ON "journal_entry"("ownerId", "date");
...
-- AddForeignKey
ALTER TABLE "journal_entry" ADD CONSTRAINT "journal_entry_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
